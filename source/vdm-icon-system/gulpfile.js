...
gulp.task("jsonIconUtility", ["icon-utility"], function() {
  gulp
    .src("icons/utility/svgs-inline-use/*.svg")
...
gulp.task("jsonIconEditorial", ["icon-editorial"], function() {
  gulp
    .src("icons/editorial/svgs-inline-use/**/*.svg")
...
gulp.task("default", ["clean"], function() {
  production = false;
  gulp.start("jsonIconUtility", "jsonIconEditorial");
});
